...
// index.js
var _chmpsJs = require("./chmps.js"); // Importa la función desde api.js
document.getElementById('button').addEventListener('click', async function() {
    ...
    try {
        const champions = await (0, _chmpsJs.getChampionsData)();
...
},{"./chmps.js":"025KE"}],"025KE":[function(require,module,exports,__globalThis) {
// api.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getChampionsData", ()=>getChampionsData);
